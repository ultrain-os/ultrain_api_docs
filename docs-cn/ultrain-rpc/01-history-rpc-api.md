...
| 方法                                                                                        | 描述                                             |
| :------------------------------------------------------------------------------------------| :------------------------------------------------|
| [getAccountByName](docs-cn/ultrain-rpc/01-history-rpc-api#getAccountByName)                |根据账户名称获取账户信息                              |
| [getActionsByAccount](docs-cn/ultrain-rpc/01-history-rpc-api#getActionsByAccount)          |根据账户名称查找其所有的交易行为                       |
| [getActionsByTxid](docs-cn/ultrain-rpc/01-history-rpc-api#getActionsByTxid)                |根据交易id查找相应的交易行为                          |
| [getAllAccounts](docs-cn/ultrain-rpc/01-history-rpc-api#getAllAccounts)                    |获取全部的账户信息                                   |
| [getAllBlocks](docs-cn/ultrain-rpc/01-history-rpc-api#getAllBlocks)                        |获取全部的区块信息                                   |
| [getAllTokens](docs-cn/ultrain-rpc/01-history-rpc-api#getAllTokens)                        |获取所以的代币信息                                   |
| [getAllTxs](docs-cn/ultrain-rpc/01-history-rpc-api#getAllTxs)                              |获取全部的交易信息                                   |
| [getBaseInfo](docs-cn/ultrain-rpc/01-history-rpc-api#getBaseInfo)                          |获取基本信息                                        |
| [getContractByName](docs-cn/ultrain-rpc/01-history-rpc-api#getContractByName)              |根据合约名称查找完整合约信息                           |
| [getContracts](docs-cn/ultrain-rpc/01-history-rpc-api#getContracts)                        |获取全部的合约信息                                   |
| [getCreateAccountByName](docs-cn/ultrain-rpc/01-history-rpc-api#getCreateAccountByName)    |根据合约名称查找账户创建者                            |
| [getHoldersBySymbol](docs-cn/ultrain-rpc/01-history-rpc-api#getHoldersBySymbol)            |根据代币名称和创建者获取其代币持有者                    |
| [getTokenBalanceByAccount](docs-cn/ultrain-rpc/01-history-rpc-api#getTokenBalanceByAccount)|根据账户名获取代币余额                                |
| [getTokenBySymbol](docs-cn/ultrain-rpc/01-history-rpc-api#getTokenBySymbol)                |根据代币名称和创建者获取其代币的基本信息                 |
| [getTxByTxId](docs-cn/ultrain-rpc/01-history-rpc-api#getTxByTxId)                          |根据交易id查找相应的交易信息                           |
| [getTxsByBlockNum](docs-cn/ultrain-rpc/01-history-rpc-api#getTxsByBlockNum)                |根据区块块高查询交易信息                               |
| [getTxTraceByTxid](docs-cn/ultrain-rpc/01-history-rpc-api#getTxTraceByTxid)                |根据交易id查找交易信息                                |
| [search](docs-cn/ultrain-rpc/01-history-rpc-api#search)                                    |根据账户名、块高、交易hash和合约名查询交易、区块、合约和账户|
